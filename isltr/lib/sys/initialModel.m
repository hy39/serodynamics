...
if strcmp(mode,'4.11') %Change seed -> 1
    setTitresModel();
    seed = 1;
end

if strcmp(mode,'4.12') %Change seed -> 3
    setTitresModel();
    seed = 3;
end

if strcmp(mode,'4.13') %Change seed -> 100
    setTitresModel();
    seed = 5;
end

if strcmp(mode,'4.14') %Change seed -> 100
    setTitresModel();
    seed = 20;
end

if strcmp(mode,'4.15') %Change seed -> 30
    setTitresModel();;
    seed = 30;
end

if strcmp(mode,'4.16') %Change seed -> 100
    setTitresModel();
    seed = 100;
end

if strcmp(mode,'4.17') %Change seed -> 100
    setTitresModel();
    seed = 1000;
end
...
function [] = setTitresModelImmune()
    x0 =     [0.06,  6,     6,     6,     6,     2    4 ];
    var =    [0.005  0.15   0.15   0.15   0.15   0.2  0.5];
    lb =     [0.01   1      1      1      1      0.5  1];
    ub =     [1      8      8      8      8      10   10];
    
    mu = x0;
    va =     [0.005  0.15   0.15   0.15   0.15   0.5   0.5]; %used for normal prior  
    x_name = {'beta','AbB1','AbB2','AbB3','AbB4','immune_alpha','ContFrac1'};
...
function [] = setTitresModelBoost()
        x0 =     [0.06,  6,     2,      2,         2,        2       4   ];
        var =    [0.005  0.15   0.2     0.2        0.2       0.2     0.5 ];
