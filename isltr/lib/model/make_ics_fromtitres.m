...
%pop = [3009303, 8731641, 19889635, 12707659, 8453916]; % Jun 17, 2014
%pop = [3009303, 8731641, 19889635, 12707659+8453916]; %Jul 14, 2014
%%%^^^^ Should change this pop into HK population
%0-19; 20-39; 40-64; >65
%pop = [17.6000 29.7 39.4 13.2000];

%0 5; 6 19; 20 64; 65 100 
%check InitParameters
pop = [4.1 13.5 69.1 13.2];
%%% 2July 2014

%pop = [10000*(0.9^0), 10000*(0.9^2), 10000*(0.9^2), 10000*(0.9^3), 10000*(0.9^4)];
