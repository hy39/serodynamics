function [FigH FigL log peak peak_lb peak_ub] = figureX4_prevalence_post()
...
[rmse_2h rmse_2f] = plotI(dat2, 1, mark, 1);
sample_time_K1 = 102;
sample_time_K2 = 235;
               ...
               %if posterior(idx(i),p) > 3  
                 ...
                 %R0_new(i) = calculateR0_fromPars(pars);
                  ...
                  elseif mode == 1
                      ...
                      [pars] = setParameters(pars,char(vars(p)),0.0494*0.965);
                  end
