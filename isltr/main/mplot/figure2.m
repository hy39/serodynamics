...
%subplot(2,1,2);
    ...
    plot_grid( Y_mean(T0:T0-60+515,:), pars, T_rel, agegroup ); % Plot the figure as objective1 in meeting
...
set(gca,'xtick',[]);
hold on;
[total_infecteds sero log CI_T1T2] = plot_area( Y_mean(T0:T0-60+515,:), pars, T_rel, 1, agegroup);
