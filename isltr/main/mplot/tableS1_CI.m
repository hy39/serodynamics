function [FigH FigL log peak peak_lb peak_ub] = tableS1_CI()
...
[seroprev_ch_mean_0 seroprev_ch_lb_0 seroprev_ch_ub_0 CI_mean CI_lb CI_ub CI_mean_tot CI_lb_tot CI_ub_tot] = plotI(resample_post, dat1, 1, [], mode);
CI_mean
CI_lb
CI_ub
CI_mean_tot
CI_lb_tot
CI_ub_tot
CI.Titre.CI_mean = CI_mean;
CI.Titre.CI_lb = CI_lb;
CI.Titre.CI_ub = CI_ub;
CI.Titre.CI_mean_total = CI_mean_tot;
CI.Titre.CI_lb_total = CI_lb_tot;
CI.Titre.CI_ub_total = CI_ub_tot;


dat2 = load('out/p0e05/m2/ph1n1/20151024/mcmc_output_m2_final.mat');               % default model Titre.Full
resample_post2 = resamples(dat2, samplesize);
[seroprev_ch_mean_0 seroprev_ch_lb_0 seroprev_ch_ub_0 CI_mean CI_lb CI_ub CI_mean_tot CI_lb_tot CI_ub_tot] = plotI(resample_post2, dat2, 1, [], mode);
CI_mean
CI_lb
CI_ub
CI_mean_tot
CI_lb_tot
CI_ub_tot
CI.Threshold.CI_mean = CI_mean;
CI.Threshold.CI_lb = CI_lb;
CI.Threshold.CI_ub = CI_ub;
CI.Threshold.CI_mean_total = CI_mean_tot;
CI.Threshold.CI_lb_total = CI_lb_tot;
CI.Threshold.CI_ub_total = CI_ub_tot;

save('CI_models.mat','CI');
...
function [seroprev_a_change_mean seroprev_a_change_lb seroprev_a_change_ub CI_mean CI_lb CI_ub CI_total_mean CI_total_lb CI_total_ub] = plotI(post, dat, display, marker, mode)
...
T_rel = times(1:365)+1;  %The relative days after 120d 
    ...
    CI_K2_1 = CInfecteds_age(1, sample_time_K2);
    CI_K2_2 = CInfecteds_age(2, sample_time_K2);
    CI_K2_3 = CInfecteds_age(3, sample_time_K2);
    CI_K2_4 = CInfecteds_age(4, sample_time_K2);
    CI_mean = ([CI_K2_1 CI_K2_2 CI_K2_3 CI_K2_4])./pars.age_arr;
    CI_total_mean = sum([CI_K2_1 CI_K2_2 CI_K2_3 CI_K2_4]);
    ...
    CI_K2_1_lb = CInfecteds_age(1, sample_time_K2);
    CI_K2_2_lb = CInfecteds_age(2, sample_time_K2);
    CI_K2_3_lb = CInfecteds_age(3, sample_time_K2);
    CI_K2_4_lb = CInfecteds_age(4, sample_time_K2);
    CI_lb = ([CI_K2_1_lb CI_K2_2_lb CI_K2_3_lb CI_K2_4_lb])./pars.age_arr;
    CI_total_lb = sum([CI_K2_1_lb CI_K2_2_lb CI_K2_3_lb CI_K2_4_lb]);
    ...
    CI_K2_1_ub = CInfecteds_age(1, sample_time_K2);
    CI_K2_2_ub = CInfecteds_age(2, sample_time_K2);
    CI_K2_3_ub = CInfecteds_age(3, sample_time_K2);
    CI_K2_4_ub = CInfecteds_age(4, sample_time_K2);
    CI_ub = ([CI_K2_1_ub CI_K2_2_ub CI_K2_3_ub CI_K2_4_ub])./pars.age_arr;
    CI_total_ub = sum([CI_K2_1_ub CI_K2_2_ub CI_K2_3_ub CI_K2_4_ub]);
