function [FigH FigL log peak peak_lb peak_ub] = figure2_seroprev()
...
for i = 1:samplesize
    ...
    x0 = yini;  
    %x0 = [x0 zeros(1,40)]; %with Java clas Serology
    x0 = [x0 zeros(1,80)]; %with Java class SerologySR
