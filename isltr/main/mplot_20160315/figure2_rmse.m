function [FigH FigL log peak peak_lb peak_ub] = figure2_rmse()
...
dat2 = load('out/test/m2/ph1n1/20160313/mcmc_output_m2_final.mat');
...
function [RMSE_half RMSE_full] = plotI(dat, display, marker)
